...
export const appInfo = {
  name: 'ReelSlider',
  fullName: 'ReelSlider — Instagram Video Controls',
  tagline: 'Real Video Controls for Instagram',
  description: 'Real video controls on Instagram. Seek, volume & speed on reels, stories, feed & posts.',
  version: APP_VERSION,
  logPrefix: '[ReelSlider]',
};
...
export const SUPPORT_URL = 'https://github.com/Sumedhvats/';
